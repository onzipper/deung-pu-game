...
/** action ที่ทำได้กับ item ตามตำแหน่งปัจจุบัน — อยู่กระเป๋า = สวมใส่ได้, สวมอยู่ = ถอดได้เท่านั้น */
export type InventoryAction = "equip" | "unequip";

export function resolveInventoryAction(location: InventoryItemLocation): InventoryAction {
  return location === "CHARACTER_EQUIPMENT" ? "unequip" : "equip";
}
