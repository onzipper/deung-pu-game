...
export const HELP_ARTICLES: readonly HelpArticle[] = [
  ...
  {
    // OB — Field Boss หมูป่าหม้อเดือด + Arc1 Ch1 flavor (โทนสดใส/meme, D-064). category = combat (วิธีสู้บอส).
    id: "field_boss",
    category: "combat",
    title: "หมูป่าหม้อเดือด (บอสประจำแมพ)",
    oneLine: "บอสประจำ Map 1 อยู่ลาน boss ทางใต้สุด — เลือดหนามาก ล้มได้ดรอปวัสดุเสริมแกร่ง + ของหายาก",
    steps: [
      "เดินลงใต้สุดของแผนที่ไปที่ลาน boss (หมุดก้อนหินใหญ่)",
      "ใส่เกราะ/ตีบวกให้พร้อม หรือชวนเพื่อนรุมก่อนลุย (เลือด 2500)",
      "ล้มได้ = วัสดุเสริมแกร่ง + แกนเสียงสะท้อน + โอกาสของ Rare",
    ],
    moreDetail:
      "บทที่ 1 ล่าดึ๋งปุ๊ — งานปกติของชาวเมืองขอบนคร: ครูฝึกบอกให้ไปเก็บดึ๋งปุ๊ ใส่เกราะ แวะช่างตีเหล็กตีบวก แล้วค่อยไปท้าหมูป่าหม้อเดือดที่พ่นไอเดือดคลุ้งอยู่ลานใต้ ใครล้มได้กลายเป็นตำนานร้านเหล้า ...ว่าแต่ ช่วงนี้มีแสงม่วง ๆ วาบที่ขอบทุ่งอยู่บ่อย ๆ แฮะ",
    action: { type: "none" },
    applicableScreens: [],
  },
  {
