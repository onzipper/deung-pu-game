...
- `src/ui/panels/bot/` — 4-tab Bot Hub. PR2 live CTA is exactly “รับช่วงต่อ”; “หยุดแผน” is separate. Checkpoint shows saving/ready/failed and “ทำต่อ” only when ready. bot-view.ts owns pure labels/caps/pocket mirror. Purchase is MOCK (D-061). Never conflate Bot with Auto Pilot (D-037) or Dung-Dung (D-035).
