...
- `src/ui/panels/bot/` — 4-tab Bot Hub. PR2 CTA “รับช่วงต่อ” ≠ “หยุดแผน”; checkpoint gates “ทำต่อ”. PR3 status carries server continuity while legacy action remains until PR7 UX. Purchase MOCK (D-061); Bot ≠ Auto Pilot/Dung-Dung.
