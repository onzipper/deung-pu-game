...
- `src/ui/panels/bot/` — 4-tab Bot Hub. PR2 CTA “รับช่วงต่อ” ≠ “หยุดแผน”; checkpoint gates “ทำต่อ”. PR4 status/stopped messages carry server continuity through Free safe-stop settlement, while the technical-profile-first presentation and legacy action remain until PR7 UX. Purchase MOCK (D-061); Bot ≠ Auto Pilot/Dung-Dung.
