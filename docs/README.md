...
| ไฟล์ | บทบาท |
|---|---|
| `tech/deungpu_technical_architecture_v1.md` | **Tech architecture v1.4** — stack, locked decisions §0.1, MVP plan P0–P6 §12, engine foundation §17, spawn/aggro §18 |
...
**Ownership rule (v14 §59.4):** Design owns what the skill is; Tech owns how it runs. Field names ตาม v14 §50.1 เท่านั้น
