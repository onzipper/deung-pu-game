...
| `design/deungpu_P2_UI_VISUAL_IMPLEMENTATION_SPEC_v1.md` | **UI/Visual Implementation P2 (DRAFT — รอเคาะ U1เศษ/U2–U4)** — design tokens, component library, ทุกจอ P2 + mobile HUD 2 layouts ระดับไม่ต้องมี Figma · ห้าม implement ส่วนที่ mark PENDING OWNER (§7.1 ถูก supersede โดยเล่ม Storage แล้ว) |
