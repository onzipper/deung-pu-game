...
| File | Role |
|---|---|
| `design/deungpu_project_checkpoint_v15_p0_scope_lock_ready.md` | **Game spec v15.4** (in-place amendments, log §0.0.x) — §4.1 Character Autonomy · §48 Design Knobs · §50.1 skill schema · §57/§59 engine+runtime decisions |
...
| `design/deungpu_P3_BOT_AND_REPORT_UI_IMPLEMENTATION_SPEC_v1.md` | Character Autonomy plan/takeover/report UI (D-067 amendment §0.0; historical Bot UI text may be superseded) |
...
| `tech/deungpu_RUNTIME_BOT_CHANNEL_AND_SCHEMA_OWNERSHIP_DECISIONS_v1.md` | Runtime lock v1.1 (real-character autonomy; §3 worker model superseded) |
