...
1. **PR #10 (คลื่น 2) ทดสอบผ่านครบทุกข้อแล้ว (2026-07-12) — พร้อม merge เข้า develop รอ owner เคาะ** (https://github.com/onzipper/deung-pu-game/pull/10) · เส้นทางทดสอบ: รอบ 1 ข้อ 4-5 ผ่าน / รอบ 2 ข้อ 8 ผ่าน + เจอบั๊กลึกข้อ 6-7 / review-fix รอบ 3 (fetch this-binding + hub key remount — ดู Latest work) → owner ยืนยันผ่านครบ 3 รายการ (เด้ง /hub เมื่อเข้า /game ตรง, map+ตำแหน่งเดิมผ่าน hub, logout/login ลิสต์ตัวละครโผล่ทันที) · merge = owner action (AI.md) — merge แล้วเริ่มคลื่น 3 ได้ทันที
