...
- **Art track:** เกมใช้ chr_crimson_knight v3 · intake ผ่าน `/sprite-intake` (contract: `scripts/art/templates/`) · owner ผลิต sheet ด้วย ChatGPT — v7 ตีกลับ (ทิศแก้แล้ว เหลือตัวเกินช่อง+เฟรมเกิน) · JSON engine-schema 576×1440 เตรียมพร้อมแล้วรอแค่ภาพผ่าน
