...
| P2-12/13/15/17 DG lite, tab policy (D-056), mobile pass, storage/delivery | GS v15.2 · TA v1.5.2 | not started — see `docs/tech/deungpu_P2_ISSUE_BREAKDOWN_v1.md` | (planned) |
