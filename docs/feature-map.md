...
| Direction resolver 5-dir + mirror | TA §17.4 · GS §57.2 | `src/engine/movement/direction.ts` (logical ทิศ เสร็จ · sprite mapping รอ P0-06) | `tests/engine-movement-direction.test.ts` |
