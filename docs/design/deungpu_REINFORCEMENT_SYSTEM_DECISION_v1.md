...
→ เคาะแล้ว 2026-07-13: แทนทั้ง 5 grant (+§15.2 source table + §11.6 first-kill bonus) ด้วย **Gold** — จำนวน = `PENDING OWNER BALANCE` (ไม่มี learning grant)
...
→ เคาะแล้ว 2026-07-13: placeholder linear +6..+15 (delta ≈ 0.07/ระดับ, +15 ≈ ×2.05) mark `PENDING OWNER BALANCE` รวม bucket E3 — production curve เคาะตอน P2B
