...
> **สถานะ:** `LOCKED (owner เคาะ 2026-07-12)` สำหรับ E1 + ระบบเสริมแกร่งการันตี + rename แกร่ง→เสริมแกร่ง · `RESOLVED 2026-07-13 (D-055)` สำหรับ E3 (monster combat balance) · R5 Gold + R9 multiplier +6..+15 เคาะแล้ว 2026-07-13 (D-053/D-054)
> **วันที่:** 2026-07-12 (amend 2026-07-13 = R5/R9/E3 ค่าจริง)
> **supersedes:**
...
> **✅ RESOLVED 2026-07-13 (D-054, ดู R9):** multiplier `+6..+15` เคาะแล้ว = Option A (ต่อ curve เดิม delta เร่ง +0.01/ระดับ): +6 1.45 · +7 1.56 · +8 1.68 · +9 1.81 · +10 1.95 · +11 2.10 · +12 2.26 · +13 2.43 · +14 2.61 · **+15 2.80** · เขียนลง Economy §16.3.1 แล้ว
...
reinforcementItem:
  ...
  bindType: TRADE_LIMITED     # เคาะ 2026-07-13 (R1) — เทรดตรงตัวผู้เล่นได้ ห้าม list ตลาดกลาง
  tradable: true              # ข้อความที่ 2: trade ได้ (supersede false)
  sellable: true              # ขายเฉพาะตลาดผู้เล่น — ไม่ขายเข้า NPC (R2 เคาะ 2026-07-13)
...
reinforcementFragment:
  ...
  materialId: upg_reinforcement_fragment   # เคาะแล้ว 2026-07-13 (R3 — ดู §3.5)
...
| bindType | `ACCOUNT_BOUND` | (ขัดกับ trade ได้) | **`TRADE_LIMITED` (R1 เคาะ 2026-07-13)** |
...
## 9. E3 — ค่าสถานะมอนสเตอร์ (✅ RESOLVED 2026-07-13 · D-055)

> **เคาะแล้ว 2026-07-13 (D-055):** Map 1 Monster Combat Stat Table = production ครบ 5 ตัว + ล็อก player baseline (P1 Balance Proposal §2.1) เป็น production คู่กัน · `breakPower` = guard gauge บอส (normal/elite=0) · E3 เอาเฉพาะตัวเลข stat — pattern ท่า elite/boss รอ Kit Proposal แยก · ตารางเต็มด้านล่าง §9.3 (เนื้อ §9.2 เดิมคงไว้เพื่อ history)
...
### 9.3 Production stat table (RESOLVED 2026-07-13 · D-055) — supersede §9.2 `pending-owner-balance`

สูตร: `DMG = ATK × baseMultiplier × [50 / (50 + effectiveDEF)]` (Combat Bible §2, k=50) · `breakPower` = guard gauge บอส (ปริมาณ break ที่ผู้เล่นต้องทุบ; normal/elite = 0)
...
TTK เป้าหมาย (vs player level เดียวกัน, basic attack cd 0.6s mult 1.0): slime ~2.4s · bird ~3.0s · boar ~5.1s · elite ~16.8s · boss ~109s + break (boss ~2 นาที solo = รับได้) · identity/EXP/Gold/Respawn คงตาม §9.1 + Economy §10.1

**Player baseline (production, D-055 — P1 Balance Proposal §2.1):** lv1 HP100/ATK12/DEF8 · lv2 120/15/9 · lv4 160/21/12 · lv5 180/24/14 · lv8 240/33/18 · growth/lv HP+20/ATK+3/DEF+~1.5 · monster HP tune ให้เข้า TTK บน baseline นี้ (คู่กัน — baseline เปลี่ยน = monster HP rescale)
...
| เศษเสริมแกร่ง item + exchange UI + recipe | **P2B (R7 เคาะ 2026-07-13)** | ดู §3.5 — P2 ทำแค่ config/flag |
...
> **สถานะ: เคาะครบทั้ง 10 ข้อแล้ว (R3+R7 = 2026-07-13 เช้า · ที่เหลือ = owner "โอเคทั้งหมด" 2026-07-13)** — ผลอยู่ที่บรรทัด `→ เคาะแล้ว` ท้ายแต่ละข้อ; เนื้อคำถาม/แนะนำเดิมคงไว้เป็นบริบท
...
→ เคาะแล้ว 2026-07-13: `bindType: TRADE_LIMITED` — เทรดตรงตัวผู้เล่นได้ ห้าม list ตลาดกลาง (ใช้ทั้งเสริมแกร่ง + เศษเสริมแกร่ง)
...
→ เคาะแล้ว 2026-07-13: ขายเฉพาะตลาดผู้เล่น/เทรด — **ไม่ขายเข้า NPC** (`sellable` ตีความ = player market เท่านั้น)
...
→ เคาะแล้ว 2026-07-13: flat 1 ชิ้น/ขั้นทุกระดับ — long-term chase = intended · ทบทวน curve ที่ P2B ด้วย telemetry
...
→ เคาะแล้ว 2026-07-13: แทนทั้ง 5 grant (+§15.2 source table + §11.6 first-kill bonus) ด้วย **Gold** — ไม่มี learning grant
→ **ค่าจริง 2026-07-13 (D-053, Option A สเกลตาม milestone, เพิ่มบนคอลัมน์ Gold เดิม):** `ms_enhancement_ready` +100 (รวม 200) · `ach_first_upgrade` +100 (รวม 100) · `ms_first_elite` +150 (รวม 350) · `ms_map1_complete` +250 (รวม 550) · `ms_boss_first_kill` +200 (รวม 400) · `questMilestoneTotals.kraeng`=0, `bossFirstKillBonus.kraeng`=0 · เขียนลง Economy §18.3 แล้ว
...
→ เคาะแล้ว 2026-07-13: เลื่อน re-spec audio เต็มไป **P2B audio pass** — คง superseded marks ปัจจุบันไว้
...
→ เคาะแล้ว 2026-07-13: (ก) enhancement UI ship ใน P2 แบบ inert (`NO_REINFORCEMENT`) + hint panel/ดึ๋งๆ สื่อสาร "เสริมแกร่ง = ของหายาก ดรอปจากบอส/ความท้าทาย" (เนื้อ copy = content track P2-12)
...
→ เคาะแล้ว 2026-07-13 (placeholder ชั่วคราว): linear +6..+15 (delta ≈ 0.07/ระดับ, +15 ≈ ×2.05) mark `PENDING OWNER BALANCE`
→ **ค่าจริง 2026-07-13 (D-054, Option A — ต่อ curve เดิม delta เร่ง +0.01/ระดับ, supersede placeholder linear):** +6 1.45 · +7 1.56 · +8 1.68 · +9 1.81 · +10 1.95 · +11 2.10 · +12 2.26 · +13 2.43 · +14 2.61 · **+15 2.80** · rule "min +1 เมื่อข้ามระดับ" ใช้ต่อ · เขียนลง Economy §16.3.1 แล้ว
...
→ เคาะแล้ว 2026-07-13: ยืนยัน `upg_reinforcement` เป็น canonical materialId (แทน `upg_kraeng` ทุกที่ตั้งแต่ P2-09/P2-10) — งาน rename ปิดก่อน P2-16 apply DB
...
4. **Economy §16.3 multiplier** หยุดที่ +5 → ✅ เติม +6..+15 แล้ว (Economy §16.3.1 · D-054 · 2026-07-13)
